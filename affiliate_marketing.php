		...
		<div class="row">
            <div class="col-sm-12 text-center breadcrumbs_inner">
                <h2 class="breadcrumbs-title">
					...
					<article id="post-6786" class="post-6786 fw-services type-fw-services status-publish has-post-thumbnail hentry fw-services-category-our-services-2">
				<!-- .entry-header -->
...
<?php include 'form.php'; ?>
...
</section><section  id="video-section" class="fw-main-row section  ls ms section_padding_top_50 section_padding_bottom_50 columns_padding_15 fullwidth-section   half_section container" >
	...
	<span class=" medium text-capitalize">
		Benefits of affiliate marketing	</span>
	</h3>
</div>
<div class="text-block shortcode ">
    ...
    <div class="top_corner_body"></div>
	    <div class="container">
        <div class="row">
			<div  id="column-cd4bbda" class="col-xs-12 col-md-2 fw-column"  >
	</div><div  id="column-0f290b3" class="col-xs-12 col-md-8 fw-column"  >
...
>
...
</div><div  id="column-7496f81" class="col-xs-12 col-md-2 fw-column"  >
	</div>        </div>
    </div>
    <div class="bottom_corner_body"></div>
</section><section  id="#benefit-sec-wrap" class="fw-main-row section  ls section_padding_top_50 section_padding_bottom_30 columns_padding_15 fullwidth-section  " >
	...
	<h3 class="section_header margin_0 heading-wrapper ">
	<span class=" medium text-capitalize">
		Gratis' role: How can we help	</span>
	</h3>
</div>
<div class="text-block shortcode ">
